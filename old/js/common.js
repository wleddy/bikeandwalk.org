/* common.js for bikeandwalk.org */


/* ScreenSteps "PrettyPhoto"*/
 ...
 * ------------------------------------------------------------------------- */
/* 
	Modified Feb 3, 2016  by Bill Leddy to eliminate the use of .browser function which
	was removed by jQuery
*/
...
//						if ($.browser.msie && $.browser.version == 6) $('select').css('visibility', 'visible');
				...
				function _getDimensions(width, height) {
					...
					$pp_details.remove();pp_contentHeight=height+detailsHeight;pp_contentWidth=width;pp_containerHeight=pp_contentHeight+$ppt.height()+$pp_pic_holder.find('.pp_top').height()+$pp_pic_holder.find('.pp_bottom').height();pp_containerWidth=width;}
